...
public class Formulario_Anadir_Trabajador {
	 ...
	 */
	public Formulario_Anadir_Trabajador(JFrame padre) {
		this.padre = padre;
		initialize();
	}
	...
	private void initialize() {
		...
		JButton btnAnadirCliente = new JButton("A\u00F1adir Trabajador");
		btnAnadirCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					gestor.anadir_trabajador(txtDNI.getText(), txtNombre.getText(), txtApellidos.getText(),
		...
		btnAnadirCliente.setBounds(145, 212, 137, 25);
