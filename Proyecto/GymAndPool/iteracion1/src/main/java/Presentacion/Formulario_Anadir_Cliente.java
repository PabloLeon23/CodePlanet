...
public class Formulario_Anadir_Cliente {
	...
	public Formulario_Anadir_Cliente(JFrame padre) {
		this.padre = padre;
		initialize();
	}
	...
	private void initialize() {
		...
		JButton btnAnadirCliente = new JButton("A\u00F1adir");
		btnAnadirCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					gestor.anadir_cliente(txtDNI.getText(), txtNombre.getText(), txtApellidos.getText(),
		...
		btnAnadirCliente.setBounds(171, 282, 97, 25);
